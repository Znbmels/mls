"""
Django settings for quranlearning project.
...
SECRET_KEY = 'django-insecure-5i(&8n@*bn7&^9_9#%1hg63-k(9z1p-q96@6scih3y241_$%el'
...
INSTALLED_APPS = [
    ...
    'myapp1',  # Ваше приложение
    'rest_framework',
    'drf_yasg',
    'rest_framework.authtoken',  # Если вы хотите оставить TokenAuthentication
    'rest_framework_simplejwt',  # Новое: JWT
]
...
ROOT_URLCONF = 'quranlearning.urls'
...
WSGI_APPLICATION = 'quranlearning.wsgi.application'
